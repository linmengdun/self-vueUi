<template>
  <div class="status-bar">
    ...
    <div class="content">
      <div class="section action current-project" v-tooltip="$t('org.vue.components.status-bar.project.tooltip')"
      ...
      <div class="section action console-log" v-tooltip="$t('org.vue.components.status-bar.log.tooltip')"
        @click="onConsoleClick()">
        <VueIcon icon="dvr" />
        <!-- <LoggerMessage class="last-message" v-if="consoleLogLast" :message="consoleLogLast" /> -->
        <!-- <div v-else class="last-message">{{ $t('org.vue.components.status-bar.log.empty') }}</div> -->
      </div>
      <div class="section action person" v-tooltip="$t('org.vue.components.status-bar.person')">
        <VueIcon icon="person" />
        {{ fullname }}
      </div>
      <div v-if="enableDarkModeButton" class="section action dark-mode"
        v-tooltip="$t('org.vue.components.status-bar.dark-mode')" @click="toggleDarkMode()">
